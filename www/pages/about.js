  ...
  <ParallaxProvider>
    <>
      ...
      <ContentSection title="How We Got Started">
        <ContentDetail>
          <HighlightImage src="../static/images/bartender.jpg" height="25rem" />
          <p>
      ...
      <ContentSection title="Inspired Menu" color="light">
        <ContentDetail align="right">
          ...
          <p>
            ...
            weekly specials such as Marlin, Amberjack and Soft Shell Crab. One
            of our signature appetizers is a Clearwater-inspired smoked fish
            spread made from scratch in the Sand Bar's kitchen by our own chef.
            We feature fresh-shucked oysters every Friday, Saturday and Sunday
            along with steamed mussels bathed in garlic butter and white wine.
            For those who prefer "turf" over "surf" we serve three top-quality
            Filet Mignon "Sliders" on toasted buns topped with Dijon Mayonaise
